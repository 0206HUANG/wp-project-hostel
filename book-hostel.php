...
if(isset($_POST['submit'])) {
    ...
    // Ensure all column names match those in your table
    $query = "INSERT INTO registration (roomno, seater, feespm, course, regno, firstName, middleName, lastName, gender, contactno, emailid, egycontactno, guardianName, guardianRelation, guardianContactno, corresAddress, corresCity, corresState, corresPostcode, pmntAddress, pmntCity, pmnatetState, pmntPostcode) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $mysqli->prepare($query);
    $stmt->bind_param(
        'iissssssssissssssisssss',
        $roomno, $seater, $feespm, $course, $regno, $fname, $mname, $lname, $gender, $contactno, $emailid, $emcntno, $gurname, $gurrelation, $gurcntno, $caddress, $ccity, $cstate, $cpincode, $paddress, $pcity, $pstate, $ppincode
    );
    ...
    <div class="ts-main-content">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-title" style="margin-top:5%">Registration </h2>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <form method="post" action="" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Fees Per Sem</label>
                                                <div class="col-sm-8">
